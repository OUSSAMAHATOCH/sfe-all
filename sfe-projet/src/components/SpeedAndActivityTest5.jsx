...
const SpeedAndActivityTest5 = ({ control }) => {
  return (
    <>
      <Grid
        container
      ...
      >
        <Grid item xs={12} sm={2} alignItems="center">
          {" "}
          <Controller
            name="speedAndActivityTest5.variatorSpeed"
            control={control}
        ...
        <Grid item xs={12} sm={2} alignItems="center">
          <Controller
            name="speedAndActivityTest5.chronoSpeed"
            control={control}
            render={({ field: { value, onChange } }) => (
              <TextInput
                label="chronoSpeed"
        ...
        <Grid item xs={12} sm={2} alignItems="center">
          <Controller
            name="speedAndActivityTest5.gap"
            control={control}
            render={({ field: { value, onChange } }) => (
              <TextInput
                label="ecart"
        ...
        <Grid item xs={12} sm={3} alignItems="center">
          <Controller
            name="speedAndActivityTest5.compliant"
            control={control}
            render={({ field: { value, onChange } }) => (
              <RadioInput
...
SpeedAndActivityTest5.propTypes = {
  control: PropTypes.object,
  compliant: PropTypes.bool,
  gap: PropTypes.number,
  chronoSpeed: PropTypes.number,
  variatorSpeed: PropTypes.string,
};

export default SpeedAndActivityTest5;
