...
const SpeedAndActivityTest7 = ({ control }) => {
  return (
    <>
      <Grid
        container
      ...
      >
        ...
        <Grid item xs={12} sm={2} alignItems="center">
          <Controller
            name="speedAndActivityTest7.chronoSpeed"
            control={control}
        ...
        <Grid item xs={12} sm={2} alignItems="center">
          <Controller
            name="speedAndActivityTest7.gap"
            control={control}
            render={({ field: { value, onChange } }) => (
              <TextInput
                label="ecart"
        ...
        <Grid item xs={12} sm={3} alignItems="center">
          <Controller
            name="speedAndActivityTest7.compliant"
            control={control}
            render={({ field: { value, onChange } }) => (
              <RadioInput
...
SpeedAndActivityTest7.propTypes = {
...
export default SpeedAndActivityTest7;
