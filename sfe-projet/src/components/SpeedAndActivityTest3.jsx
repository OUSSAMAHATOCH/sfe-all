...
const SpeedAndActivityTest3 = ({ control }) => {
  return (
    <>
      <Grid
        container
      ...
      >
        ...
        <Grid item xs={12} sm={2} alignItems="center">
          {" "}
          <Controller
            name="speedAndActivityTest3.chronoSpeed"
            control={control}
        ...
        <Grid item xs={12} sm={2} alignItems="center">
          <Controller
            name="speedAndActivityTest3.gap"
            control={control}
            render={({ field: { value, onChange } }) => (
              <TextInput
                label="ecart"
        ...
        <Grid item xs={12} sm={3} alignItems="center">
          {" "}
          <Controller
            name="speedAndActivityTest3.compliant"
            control={control}
            render={({ field: { value, onChange } }) => (
              <RadioInput
...
SpeedAndActivityTest3.propTypes = {
...
export default SpeedAndActivityTest3;
