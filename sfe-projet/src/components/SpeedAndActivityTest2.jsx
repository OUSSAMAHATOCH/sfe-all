...
const SpeedAndActivityTest2 = ({ control }) => {
  return (
    <>
      <Grid
        container
      ...
      >
        <Grid item xs={12} sm={2} alignItems="center">
          <Controller
            name="duration"
            control={control}
            render={() => <Typography align="center">0</Typography>}
          />
        </Grid>

        <Grid item xs={12} sm={2} alignItems="center">
          <Controller
            name="speedAndActivityTest2.chronoSpeed"
            control={control}
        ...
        <Grid item xs={12} sm={2} alignItems="center">
          <Controller
            name="speedAndActivityTest2.gap"
            control={control}
            render={({ field: { value, onChange } }) => (
              <TextInput
                label="ecart"
        ...
        <Grid item xs={12} sm={3} alignItems="center">
          <Controller
            name="speedAndActivityTest2.compliant"
            control={control}
            render={({ field: { value, onChange } }) => (
              <RadioInput
...
SpeedAndActivityTest2.propTypes = {
...
export default SpeedAndActivityTest2;
